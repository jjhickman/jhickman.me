  ...
  return (
    ...
    >
      <div className='flex h-3/4 flex-col justify-center space-y-4 sm:space-y-6'>
        ...
        >
          I'm a software engineer specializing in <HighlightText>web</HighlightText>,{' '}
          <HighlightText>platform</HighlightText>, and <HighlightText>infrastructure</HighlightText>
          .
        </h1>
        <p
          className={clsx(
        ...
        >
          Senior Software Engineer: <InlineLink href='https://bostondynamics.com'>ex-Boston Dynamics</InlineLink>
        </p>
